...
- gateway 未启动、LaunchAgent 未安装、channels 未配置、sessions 为 0
- 继续确认 OpenClaw onboarding 策略；onboarding、daemon、消息通道接入均属于 L2，必须再次确认
...
| OpenClaw 路径 | /opt/homebrew/bin/openclaw | 2026-06-19 已安装 CLI，版本 2026.6.8；gateway 未启动，LaunchAgent 未安装。 |
